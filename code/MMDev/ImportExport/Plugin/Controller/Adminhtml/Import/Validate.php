<?php
/**
 * @copyright: Copyright © 2017 MMDev Studio GmbH. All rights reserved.
 * @author: MMDev Studio <fbeardev@gmail.com>
 */

namespace MMDev\ImportExport\Plugin\Controller\Adminhtml\Import;

use Magento\Framework\App\Action\Context;
use Magento\Framework\Controller\ResultFactory;
use MMDev\ImportExport\Model\Import;
...
class Validate
{
    ...
    /**
     * @var \MMDev\ImportExport\Model\Import
     */
        ...
        if ($data) {
            ...
            try {
                ...
                if (stripos($sourcePath, '.txt')) {
                    $source = new \MMDev\ImportExport\Model\Import\Source\Txt(
                        $sourcePath,
                        $directory,
