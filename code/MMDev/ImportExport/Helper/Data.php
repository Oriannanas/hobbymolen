<?php
namespace MMDev\ImportExport\Helper;

use MMDev\ImportExport\Model\Source\Factory;
...
/**
 * Class Data
 * @package MMDev\ImportExport\Helper
 */
class Data extends AbstractHelper
{
    ...
    public function getSourceModelByType($sourceType)
    {
        ...
        if ($sourceClassName && class_exists($sourceClassName)) {
            /* @var $source \MMDev\ImportExport\Model\Source\Type\AbstractType */
