...
namespace MMDev\ImportExport\Model\Source\Type;
...
class Ftp extends AbstractType
{
     ...
     *
     * @return \MMDev\ImportExport\Model\Filesystem\Io\Ftp
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    protected function getSourceClient()
    {
        if (!$this->getClient()) {
            ...
            try {
                $connection = new \MMDev\ImportExport\Model\Filesystem\Io\Ftp();
                $connection->open(
                    $settings
                );
